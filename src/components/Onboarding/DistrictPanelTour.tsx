...
const STEPS: TourStep[] = [
  {
    ...
    body: 'Номінальна потужність, поточне навантаження, температура мережі, виробництво та оцінка CO₂-економії — усе оновлюється разом із симуляцією.',
    cardPosition: 'bottom',
  ...
  },
  {
    ...
    title: 'Графіки',
    body: 'Історія навантаження, температури, виробництва та стабільності — криві ростуть у реальному часі разом із тікером мережі.',
    cardPosition: 'top',
    scrollToSelector: '[data-tour="district-charts"]',
  },
  {
    selector: '[data-tour="district-chart-load"]',
    title: 'навантаження в динаміці',
    body: 'Перший графік показує, як змінюється відсоток навантаження — основний індикатор балансу хаба.',
    cardPosition: 'top',
