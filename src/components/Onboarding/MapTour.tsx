...
const MAP_TOUR_STEPS: TourStep[] = [
  ...
  },
  {
    ...
    title: 'Стан кластера',
    body: 'Зелений — стабільно. Жовтий — високе навантаження. Червоний — проблема або атака; сусідні райони отримують додатковий потік.',
    cardPosition: 'center',
  ...
  },
  {
    ...
    body: 'Навантаження %, температура мережі, виробництво та статус оновлюються кожні ~1,6 с із симуляції.',
    cardPosition: 'bottom',
